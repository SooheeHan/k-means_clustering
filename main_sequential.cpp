...
int main()
{
	...
	sprintf(outPath, "/mirror/proc/landsat8_classified_sequential.bin"); // change it to a correct path
	sprintf(statPath, "/mirror/proc/landsat8_classified_sequential.txt"); // change it to a correct path
